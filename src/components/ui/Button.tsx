...
const variants: Record<Variant, string> = {
  primary: 'bg-aqua text-deep hover:bg-aqua-dim disabled:bg-line disabled:text-ink-3',
  tide: 'bg-apricot text-ink hover:brightness-105 disabled:bg-line disabled:text-ink-3',
